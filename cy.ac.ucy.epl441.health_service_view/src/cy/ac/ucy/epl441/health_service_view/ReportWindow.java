...
public class ReportWindow extends JFrame {
	 ...
	 */
	public ReportWindow(String hc, String week) throws ParseException {
		...
		SelectReport s=new SelectReport();
		JLabel lblNewLabel = new JLabel(s.center);
		lblNewLabel.setText(hc);
		lblNewLabel.setBounds(120, 54, 110, 16);
		contentPane.add(lblNewLabel);
		
		JLabel lblNewLabel_1 = new JLabel(s.week);
